        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="basic-form">
                    ...
                    <form action="{{ route('students.destroy', $id) }}" method="POST" class="row" enctype="multipart/form-data">
                        @csrf
                        @method('DELETE')
                        {{-- <div class="col-6">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control input-default " name="first_name" placeholder="First Name" required="true" value="{{ $student["first_name"] }}" disabled>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                <label for="name">Middle Name</label>
                                <input type="text" class="form-control input-default " name="middle_name" placeholder="Middle Name" value="{{ $student["middle_name"] }}" disabled>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                <label for="name">Last Name</label>
                                <input type="text" class="form-control input-default " name="last_name" placeholder="Last Name" required="true" value="{{ $student["last_name"] }}" disabled>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
